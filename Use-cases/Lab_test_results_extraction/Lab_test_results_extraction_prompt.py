...
EXTRACTION_PROMPT = """
TASK: Lab test results extraction

EXTRACTION TASK:
Extracting results from laboratory test results (medical lab tests)
...
OUTPUT FORMAT:
Return the extracted information as a JSON object that exactly matches the LabtestresultsextractionInfo structure shown above.
